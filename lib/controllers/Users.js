...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.register = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, password, email, userRepository, password_hash, user, secretKey, token, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, jsonwebtoken_1.sign(user.uuid, secretKey)];
                    case 4:
                        token = _b.sent();
    ...
    UsersController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var password, user, rightPassword, secretKey, token, err_2;
